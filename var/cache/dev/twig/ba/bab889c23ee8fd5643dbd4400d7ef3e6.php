...
class __TwigTemplate_7bc4bac56dfa76fa3d0cabff351bf721 extends Template
{
    private $source;
    private $macros = [];
...
{% block captcha_widget %}
    {% apply spaceless %}
        ...
        {{ form_widget(form, { 'id': user_input_id, 'value': '' }) }}
    {% endapply %}
{% endblock %}", "@Captcha/captcha.html.twig", "/home/wajih/pidev/symfonyy/ethleteinteg/vendor/captcha-com/symfony-captcha-bundle/Resources/views/captcha.html.twig");
    }
}
